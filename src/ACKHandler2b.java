 ...
 */
// ACK Handler class waits for ACKs to arrive / also writes
public class ACKHandler2b extends Sender2b implements Runnable {

    public byte[] ackData;
    public DatagramPacket ackPacket;
    public PacketList2b msgList;
    public DatagramSocket socket;
    public long timeNow;

    public ACKHandler2b(PacketList2b packetList_2b_,
                        DatagramSocket socket_) {
        ackData = new byte[2];
        ackPacket = new DatagramPacket(ackData, 2);                 // packet
        msgList = packetList_2b_;                                     // Packet2b list containing all packet data
